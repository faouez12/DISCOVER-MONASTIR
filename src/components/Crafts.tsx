                ...
                >
                    {extendedCrafts.map((craft, index) => (
                        <motion.div
                            ...
                            className="flex-none w-40 md:w-80 h-[300px] md:h-[500px] rounded-[1.5rem] md:rounded-[2.5rem] shadow-2xl relative overflow-hidden group border border-white/5 bg-black"
